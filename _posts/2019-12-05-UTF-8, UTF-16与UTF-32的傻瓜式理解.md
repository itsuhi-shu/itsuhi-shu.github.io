...
![把Big5标准下的曹操用GB标准打开就成了变巨，玩过光荣的曹操传和三国志（繁体版）的朋友应该很熟悉](/_posts/assets/samplecaocao.gif)
...
![U+2F9FF](/_posts/assets/samplegu.webp)
...
![UTF-32每次读取4个字节](/_posts/assets/sampleutf32.webp)
...
![UTF-8的转换方法](/_posts/assets/sampleutf8.webp)
...
![UTF-16 wiki示例的截图](/_posts/assets/wikiutf16.webp)

而读取时的转化方法如下图所示
![UTF-16读取2或4个字节，并加以转换](/_posts/assets/sampleutf16.webp)
